...
class Sender_Test(unittest.TestCase):
    ...
    def test_Parameter_Value_Generator_Digital(self):
        #Parameter_Value_Generator_Digital is defined to generate random values within a range in order to simulate sensor data, hence no definite assert such as assertTrue 
    ...
    def test_Send_Parameter_Data(self):
        #Send_Parameter_Data is defined to generate random values within a range in order to simulate sensor data, hence no definite assert such as assertTrue
    ...
    def test_Get_Parameter_To_Send(self):
        #Test to ensure no. of samples sent by sender is equal to prescribed limit
